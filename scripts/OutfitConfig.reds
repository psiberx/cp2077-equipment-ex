...
public abstract class OutfitConfig {
    ...
    public static func OutfitSlots() -> array<ExtraSlotConfig> = [
        ...
        ExtraSlotConfig.Create(n"Hands", n"OutfitSlots.HandLeft", 17000, [], [t"AttachmentSlots.Hands"]),
        ExtraSlotConfig.Create(n"Hands", n"OutfitSlots.HandRight", 17000, [], [t"AttachmentSlots.Hands"]),
        ...
        ExtraSlotConfig.Create(n"Fingers", n"OutfitSlots.FingersLeft", 18000, [], [t"AttachmentSlots.Hands"]),
        ExtraSlotConfig.Create(n"Fingers", n"OutfitSlots.FingersRight", 18000, [], [t"AttachmentSlots.Hands"]),

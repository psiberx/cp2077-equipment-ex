...
public abstract class OutfitConfig {
    ...
    public static func OutfitSlots() -> array<ExtraSlotConfig> = [
        ...
        ExtraSlotConfig.Create(n"Arms", n"OutfitSlots.WristLeft", 160, [], [t"AttachmentSlots.Hands"]),
        ExtraSlotConfig.Create(n"Arms", n"OutfitSlots.WristRight", 160, [], [t"AttachmentSlots.Hands"]),
        ExtraSlotConfig.Create(n"Hands", n"OutfitSlots.HandLeft", 160, [], [t"AttachmentSlots.Hands"]),
        ExtraSlotConfig.Create(n"Hands", n"OutfitSlots.HandRight", 160, [], [t"AttachmentSlots.Hands"]),
        ExtraSlotConfig.Create(n"Hands", n"OutfitSlots.HandPropLeft", 310, [], [t"AttachmentSlots.Hands"]),
        ExtraSlotConfig.Create(n"Hands", n"OutfitSlots.HandPropRight", 310, [], [t"AttachmentSlots.Hands"]),
        ExtraSlotConfig.Create(n"Fingers", n"OutfitSlots.FingersLeft", 170, [], [t"AttachmentSlots.Hands"]),
        ExtraSlotConfig.Create(n"Fingers", n"OutfitSlots.FingersRight", 170, [], [t"AttachmentSlots.Hands"]),
        ExtraSlotConfig.Create(n"Fingers", n"OutfitSlots.FingernailsLeft", 100, [], [t"AttachmentSlots.Hands"]),
        ExtraSlotConfig.Create(n"Fingers", n"OutfitSlots.FingernailsRight", 100, [], [t"AttachmentSlots.Hands"]),

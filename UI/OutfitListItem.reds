...
public class OutfitListItemController extends inkLogicController {
  ...
  protected cb func OnInitialize() -> Bool {
      ...
      this.m_checkboxFrame = root.GetWidget(n"titleAndCheckbox/checkbox") as inkWidget;
      this.m_checkbox = root.GetWidget(n"titleAndCheckbox/checkbox/checkbox") as inkWidget;
